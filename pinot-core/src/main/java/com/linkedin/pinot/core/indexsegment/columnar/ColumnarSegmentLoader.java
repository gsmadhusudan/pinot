...
public class ColumnarSegmentLoader {
  ...
  public static IndexSegment load(File indexDir, ReadMode mode)
      throws Exception {
  ...
  public static IndexSegment load(File indexDir, ReadMode mode, IndexLoadingConfigMetadata indexLoadingConfigMetadata)
    ...
    switch (mode) {
      case heap:
        return loadSegment(indexDir, ReadMode.heap, indexLoadingConfigMetadata, null);
      case mmap:
        return loadSegment(indexDir, ReadMode.mmap, indexLoadingConfigMetadata, null);
      default:
        return null;
    }
  }
