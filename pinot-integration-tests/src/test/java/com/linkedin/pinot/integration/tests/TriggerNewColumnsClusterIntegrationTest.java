...
/**
 * Integration test that extends NewColumnsClusterIntegrationTest to test triggering of new columns creation.
 */
public class TriggerNewColumnsClusterIntegrationTest extends NewColumnsClusterIntegrationTest {
